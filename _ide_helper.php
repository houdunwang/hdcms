...
')
     ...
     */ 
         ...
         * 发送验证码
         *
         * @param \App\Services\Code\[type] $account
         * @return void 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function email($account)
        {
                        /** @var \App\Services\Code\CodeService $instance */
                        $instance->email($account);
        }
                    /**
         * 发送手机短信验证码
         *
         ...
         * @static 
         */ 
        public static function mobile($account)
        {
                        /** @var \App\Services\Code\CodeService $instance */
                        $instance->mobile($account);
        }
                    /**
         * 验证码校对
         *
     ...
     */ 
        ...
        public static function lists($site, $module, $user)
        {
                        ...
                        return $instance->lists($site, $module, $user);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function cache($module = null)
        {
     ...
     */ 
         ...
         * @static 
         */ 
        public static function access($site, $user, $permission)
        {
                        /** @var \App\Services\Permission\PermissionService $instance */
                        return $instance->access($site, $user, $permission);
        }
                    /**
         * 用户是否可使用站点的模块
         *
         ...
         * @static 
         */ 
        public static function checkModuleAccess($site, $module, $user)
        {
                        /** @var \App\Services\Permission\PermissionService $instance */
                        return $instance->checkModuleAccess($site, $module, $user);
        }
                    /**
         * 提取模块、系统权限规则
         *
         ...
         * @static 
         */ 
        public static function permissionRules($site)
        {
                        /** @var \App\Services\Permission\PermissionService $instance */
                        return $instance->permissionRules($site);
        }
                    /**
         * 同步站点权限到权限表
         *
         ...
         * @static 
         */ 
        public static function syncSitePermissions($site)
        {
                        /** @var \App\Services\Permission\PermissionService $instance */
                        $instance->syncSitePermissions($site);
        }
                    /**
         * 站点权限表包含系统权限
         *
         ...
         * @static 
         */ 
        public static function siteAllPermissions($site)
        {
                        /** @var \App\Services\Permission\PermissionService $instance */
                        return $instance->siteAllPermissions($site);
        }
                    /**
         * 权限标识
         *
         ...
         * @static 
         */ 
        public static function permissionName($site, $name)
        {
                        /** @var \App\Services\Permission\PermissionService $instance */
                        return $instance->permissionName($site, $name);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function isMaster($site, $user)
        {
                        /** @var \App\Services\Site\SiteService $instance */
                        return $instance->isMaster($site, $user);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function isAdmin($site, $user)
        {
                        /** @var \App\Services\User\UserService $instance */
                        return $instance->isAdmin($site, $user);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function saveModuleRule($model, $data = [])
        {
                        /** @var \App\Services\WeChat\WeChatService $instance */
                        $instance->saveModuleRule($model, $data);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function log($model, $description = '', $properties = [], $user = null)
        {
                        /** @var \App\Services\Activity\ActivityService $instance */
                        return $instance->log($model, $description, $properties, $user);
        }
                    /**
         * 获取用户动态
         *
         ...
         * @static 
         */ 
        public static function user($user, $row = 10)
        {
                        /** @var \App\Services\Activity\ActivityService $instance */
                        return $instance->user($user, $row);
        }
                    /**
         * 所有动态
         *
