<template>
    <el-form :model="form" ref="form" label-width="80px" :inline="false" size="normal">
        <el-card shadow="never" :body-style="{ padding: '20px' }">
            ...
            <hd-validate-code v-model="form.account" type="email" :action="`site/${hd.site.id}/code/email/noexist`" placeholder="请输入邮箱" />
...
export default {
    ...
    methods: {
        async onSubmit() {
            await this.axios.put(`site/${this.hd.site.id}/user/email`, this.form)
        }
    }
}
</script>
