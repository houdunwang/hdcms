                ...
                <div class="navbar-nav flex-row order-md-last">
                    <div class="nav-item dropdown text-sm">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                            <el-image :src="hd.user.avatar" fit="cover" class="w-8 h-8 rounded-sm"></el-image>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center text-sm">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item" v-for="(menu, index) in menus" :key="index" v-show="hd.user.isSuperAdmin">
